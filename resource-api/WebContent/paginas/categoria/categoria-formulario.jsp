				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="form-group col-lg-2">
							<label>Código</label>
							<html:text styleClass="form-control input-md bloqueado" styleId="id" name="categoriaForm" property="categoria.idToString" />
						</div>

						<div class="form-group col-lg-2">
							<label>Data Cadastro</label>
							<html:text styleClass="form-control input-md bloqueado" styleId="id" name="categoriaForm" property="categoria.dataHoraCadastroToString" />
						</div>


						<div class="form-group col-lg-8">
							<label>Nome</label>
							<html:text styleClass="form-control input-md obrigatorio" styleId="nome" name="categoriaForm" property="categoria.nome" />
						</div>
					</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#nome').prop('placeholder', 'Nome da categoria. Ex: Bebidas');
